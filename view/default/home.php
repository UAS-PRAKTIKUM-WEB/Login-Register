...
<div class="main-sider">
	...
	?>
	<div class="sider-box">
		<div class="sider-box-title">STATISTIK PENGGUNA</div>
		<div class="sider-box-content">
			<ul>
				<li>JUMLAH TOPIK :<br><?php echo $Config['NumTopics']; ?></li>
				<li>JUMLAH KIRIMAN :<br><?php echo $Config['NumPosts']; ?></li>
				<li>JUMLAH TAG : <br><?php echo $Config['NumTags']; ?></li>
				<li>JUMLAH USER : <br><?php echo $Config['NumUsers']; ?></li>
			</ul>
		</div>
	</div>
</div>
